    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('announcements.create')" :active="request()->routeIs('announcements.create')">
                            {{ __('Post Live Update') }}
                        </x-nav-link>
                    @endif
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <form method="POST" action="{{ route('notifications.read-all') }}" class="me-4">
                    @csrf
                    <button class="inline-flex items-center gap-1 text-xs rounded-full bg-slate-100 text-slate-700 px-3 py-1 hover:bg-slate-200">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('announcements.create')" :active="request()->routeIs('announcements.create')">
                    {{ __('Post Live Update') }}
                </x-responsive-nav-link>
            @endif
